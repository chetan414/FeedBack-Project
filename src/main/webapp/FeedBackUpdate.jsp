	...
	<form action="updatefeedback" style="max-width: 500px; margin: auto">
		...
		<div class="input-container">
			<i class="fa fa-user icon"></i> <input class="input-field"
				type="text" value="<%=feedBack1.getId()%>" name="id"
				readonly="readonly">
		</div>

		<div class="input-container">
			<i class="fa fa-user icon"></i> <input class="input-field"
				type="text" value="<%=feedBack1.getParticepateName()%>"
				name="pname" readonly="readonly">
		</div>

		<div class="input-container">
			<i class="fa fa-star icon"></i> <select name="ratting"
				value="<%=feedBack1.getRatings()%>">
		...
		<div class="input-container">
			...
			<textarea rows="5" cols="20" value="<%=feedBack1.getDescription()%>"
