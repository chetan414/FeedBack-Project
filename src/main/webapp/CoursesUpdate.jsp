	...
	<form action="updatecourse" style="max-width: 500px; margin: auto">
		<div class="input-container">
			<i class="fa fa-globe icon"></i> <input class="input-field"
				type="text" value="<%=courses.getId()%>" name="id">
		</div>

		<div class="input-container">
			<i class="fa fa-globe icon"></i> <input class="input-field"
				type="text" value="<%=courses.getCourseName()%>" name="name">
		</div>

		<div class="input-container">
			<i class="fa fa-money icon"></i> <input class="input-field"
				type="text" value="<%=courses.getFees()%>" name="fees">
		</div>

		<div class="input-container">
			<i class="fa fa-calendar icon"></i> <input class="input-field"
				type="text" value="<%=courses.getDuration()%>" name="duration">
		</div>
